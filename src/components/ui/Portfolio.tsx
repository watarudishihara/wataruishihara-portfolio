...
const PROJECTS = [
    ...
    {
        title: "App User Behavior Embeddings",
        blurb: "Created user embeddings with neural networks to cluster 10M+ users into personas",
        tags: ["gensim", "PyTorch", "NLP","SQL", "Product Analytics", "BigQuery"],
        link: "#"
    },
    {
